...
def check_condition(container):
    ...
    for i in range(len(args.criteria)):
        if (floating[i] == ('on' in w_floating)) and \
                (names[i] == '' or names[i] in w_name) and \
                (classes[i] == '' or classes[i] in w_class) and \
                (instances[i] == '' or instances[i] in w_instance) and \
                (roles[i] == '' or roles[i] in w_role) and \
